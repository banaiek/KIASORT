...
extra_cfg = struct(...
    ...
    'enableNoiseSink',          true, ...            % Keep a low-amplitude class to absorb noise at sort time
    'mergeScaleStrength',       0, ...               % Tighten merge gates on narrow footprints (0 disables)
    'postHocMerging',           false, ...           % Post-hoc: merge similar units
    'posthocSplit',             false ...            % Post-hoc: split units whose amplitude is bimodal
    );
...
extra_varName = struct(...
    ...
    'enableNoiseSink',         'Noise Sink On',  ...
    'mergeScaleStrength',      'merge scale tighteness', ...
    'postHocMerging',          'Posthoc: Merging', ...
    'posthocSplit',            'Posthoc: Bimodal Split' ...
);
