function kiaSort
    ...
    fig = uifigure('Name','KIASort: Knowledge-Integrated Automated Spike Sorting (beta version)',...
                   'Color',figColor,...
...
%% subtab Hyperparameters
    ...
    function onPlotSorting()
        ...
        if isfield(cfg,"outputFolder")
            kiaSort_explore_sorted_results_gui(cfg, gridTab3, figColor, fig);
        else
            uialert(fig, ['Error: ' 'Path unspecified.'], 'Error');
        end
    end
