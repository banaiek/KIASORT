...
if cancel_overlap
    ...
    % overlap_length(overlap_length < jitter_gap) = jitter_gap;
    ...
    for c = 1:num_channels
        ...
        elseif inclusion(channel_pos) && channel_pos ~= main_channel_pos
            ...
            % right_overlap_length(right_overlap_length < jitter_gap) = jitter_gap;
            left_overlap_length = round(d2(left_overlap_idx)/2);
            % left_overlap_length(left_overlap_length < jitter_gap) = jitter_gap;
